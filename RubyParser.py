# Generated from Ruby.g4 by ANTLR 4.9
# encoding: utf-8
from antlr4 import *
...
class RubyParser ( Parser ):
    ...
    class Function_nameContext(ParserRuleContext):
        ...
        def id(self):
            return self.getTypedRuleContext(RubyParser.IdContext,0)
    ...
    def id(self):
        ...
        localctx = RubyParser.IdContext(self, self._ctx, self.state)
